...
| Item                                            | What's missing                                                                                                                                                                                                                                                                                                                                                                   |
| ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| End-to-end password-over-kbd-interactive denial | The client-side subtest proves the _method list_, not a prompted-then-rejected exchange; a positive prompt test would need `sshpass`/expect and — on current nixpkgs — explicitly re-enabled PAM unix auth, which no longer represents the default threat. Deliberately not built; the `sshd -T` assertion is the regression guard **→ ROADMAP "Test depth" — parked by design** |
