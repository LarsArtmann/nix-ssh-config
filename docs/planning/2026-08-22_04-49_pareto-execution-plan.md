...
**Trust and truth.** The repo currently *looks* abandoned: 9/9 CI runs red since inception,
...
| M8 | **Tag v0.1.0** *(gated on M1–M7, M9)* | First versioned release — consumers can finally pin. CHANGELOG cut + annotated tag. | 30min   |
