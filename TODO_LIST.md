...
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| 🔵     | **Ship v0.1.2 + close out issue #1.** Date the `CHANGELOG.md` `[Unreleased]` section, create the annotated tag, push tag + master, verify CI on both jobs, create GitHub _Release objects_ (none exist — also for v0.1.0/v0.1.1), then comment on and close issue #1. Blocked on maintainer authorization for remote actions. | `CHANGELOG.md` `[Unreleased]`; `gh release list` empty (2026-08-29); issue #1 open |
